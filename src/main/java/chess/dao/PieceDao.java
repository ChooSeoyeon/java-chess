...
public class PieceDao {
    ...
    public void create(PieceVO piece) {
        ...
        try (PreparedStatement statement = connection.prepareStatement(sql)) {
            ...
            throw new DatabaseConnectionException("Piece를 생성하는데 실패했습니다.", e);
        }
    }
    ...
    public List<PieceVO> findAllByBoardId(Long boardId) {
        ...
        try (PreparedStatement statement = connection.prepareStatement(sql)) {
            ...
            throw new DatabaseConnectionException("Board ID로 Piece를 찾는데 실패했습니다.", e);
        }
    }
    ...
    public Optional<PieceVO> findByBoardIdAndFileAndRank(Long boardId, int file, int rank) {
        ...
        try (PreparedStatement statement = connection.prepareStatement(sql)) {
            ...
            throw new DatabaseConnectionException("Board ID, File, Rank로 Piece를 찾는데 실패했습니다.", e);
        }
    }
    ...
    public void updateTypeAndColor(Long id, String type, String color) {
        ...
        try (PreparedStatement statement = connection.prepareStatement(sql)) {
            ...
            throw new DatabaseConnectionException("Piece의 Type과 Color를 업데이트하는데 실패했습니다.", e);
        }
    }
